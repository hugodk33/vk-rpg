...
export const damages: SeedDamage[] = [
  {
    ...
    value: JSON.stringify([
      { damage: "0", type: "gdp", st: 4 }, { damage: "0", type: "bal", st: 4 },
      { damage: "1D-5", type: "gdp", st: 5 }, { damage: "1D-5", type: "bal", st: 5 },
      { damage: "1D-4", type: "gdp", st: 6 }, { damage: "1D-4", type: "bal", st: 6 },
      { damage: "1D-3", type: "gdp", st: 7 }, { damage: "1D-3", type: "bal", st: 7 },
      { damage: "1D-3", type: "gdp", st: 8 }, { damage: "1D-2", type: "bal", st: 8 },
      { damage: "1D-2", type: "gdp", st: 9 }, { damage: "1D-1", type: "bal", st: 9 },
      { damage: "1D-2", type: "gdp", st: 10 }, { damage: "1D", type: "bal", st: 10 },
      { damage: "1D-1", type: "gdp", st: 11 }, { damage: "1D+1", type: "bal", st: 11 },
      { damage: "1D-1", type: "gdp", st: 12 }, { damage: "1D+2", type: "bal", st: 12 },
      { damage: "1D", type: "gdp", st: 13 }, { damage: "2D-1", type: "bal", st: 13 },
      { damage: "1D", type: "gdp", st: 14 }, { damage: "2D", type: "bal", st: 14 },
      { damage: "1D+1", type: "gdp", st: 15 }, { damage: "2D+1", type: "bal", st: 15 },
      { damage: "1D+1", type: "gdp", st: 16 }, { damage: "2D+2", type: "bal", st: 16 },
      { damage: "1D+2", type: "gdp", st: 17 }, { damage: "3D-1", type: "bal", st: 17 },
      { damage: "1D+2", type: "gdp", st: 18 }, { damage: "3D", type: "bal", st: 18 },
      { damage: "2D-1", type: "gdp", st: 19 }, { damage: "3D+1", type: "bal", st: 19 },
      { damage: "2D-1", type: "gdp", st: 20 }, { damage: "3D+2", type: "bal", st: 20 },
    ]),
    range: 'Melee',
  ...
  },
  {
    ...
    type: 'Physical',
    value: JSON.stringify([
      { damage: "0", type: "gdp", st: 4 },
      { damage: "1D-5", type: "gdp", st: 5 },
      { damage: "1D-4", type: "gdp", st: 6 },
      { damage: "1D-3", type: "gdp", st: 7 },
      { damage: "1D-3", type: "gdp", st: 8 },
      { damage: "1D-2", type: "gdp", st: 9 },
      { damage: "1D-2", type: "gdp", st: 10 },
      { damage: "1D-1", type: "gdp", st: 11 },
      { damage: "1D-1", type: "gdp", st: 12 },
      { damage: "1D", type: "gdp", st: 13 },
      { damage: "1D", type: "gdp", st: 14 },
      { damage: "1D+1", type: "gdp", st: 15 },
      { damage: "1D+1", type: "gdp", st: 16 },
      { damage: "1D+2", type: "gdp", st: 17 },
      { damage: "1D+2", type: "gdp", st: 18 },
      { damage: "2D-1", type: "gdp", st: 19 },
      { damage: "2D-1", type: "gdp", st: 20 },
    ]),
    range: 'Melee',
  ...
  },
  {
    ...
    type: 'Physical',
    value: JSON.stringify([
      { damage: "0", type: "cr", st: 4 },
      { damage: "1D-5", type: "cr", st: 5 },
      { damage: "1D-4", type: "cr", st: 6 },
      { damage: "1D-3", type: "cr", st: 7 },
      { damage: "1D-2", type: "cr", st: 8 },
      { damage: "1D-1", type: "cr", st: 9 },
      { damage: "1D", type: "cr", st: 10 },
      { damage: "1D+1", type: "cr", st: 11 },
      { damage: "1D+2", type: "cr", st: 12 },
      { damage: "2D-1", type: "cr", st: 13 },
      { damage: "2D", type: "cr", st: 14 },
      { damage: "2D+1", type: "cr", st: 15 },
      { damage: "2D+2", type: "cr", st: 16 },
      { damage: "3D-1", type: "cr", st: 17 },
      { damage: "3D", type: "cr", st: 18 },
      { damage: "3D+1", type: "cr", st: 19 },
      { damage: "3D+2", type: "cr", st: 20 },
    ]),
    range: 'Melee',
